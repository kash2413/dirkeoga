...
jQuery(document).ready(function($) {
	...
	$('.slide-first-img').imagesLoaded(function() {
		...
		if ( jQuery('.box-slider').length ) {
			jQuery('.box-slider').each(function() {
				var boxSlider = jQuery(this),
					boxSliderContainer = boxSlider.closest('.box-slider-container');
				...
				boxSlider.owlCarousel({
					...
					navText: ['<i class="fa fa-angle-left"><i>','<i class="fa fa-angle-right"><i>'],
					onInitialize: function(){
						if ( boxSlider.find('.box-slider-item').length <= 1 ) {
							this.settings.loop = false;
						}
						boxSliderContainer.loadImages();
					},
					onInitialized: function(){
						boxSliderContainer.removeClass('loading');
					},
					navRewind: false,
					responsive: {
						500:{
...
jQuery(document).ready(function($) {
	...
	$('.slide-first-img').imagesLoaded(function() {
		...
		if ( jQuery('.carousel-slider').length ) {
			jQuery('.carousel-slider').each(function() {
				var carouselSlider = jQuery(this),
					carouselSliderContainer = carouselSlider.closest('.carousel-slider-container');
				...
				carouselSlider.owlCarousel({
					...
					navText: ['<i class="fa fa-angle-left"><i>','<i class="fa fa-angle-right"><i>'],
					onInitialize: function(){
						if ( carouselSlider.find('.carousel-slider-item').length <= 1 ) {
							this.settings.loop = false;
						}
						carouselSliderContainer.loadImages();
					},
					onInitialized: function(){
						carouselSliderContainer.removeClass('loading');
					},
					navRewind: false,
					margin: 20,
					responsive: {
		...
		if ( jQuery('.portfolio-slider').length ) {
			jQuery('.portfolio-slider').each(function() {
				...
				portfolioSlider.owlCarousel({
					...
					navText: ['<i class="fa fa-angle-left"><i>','<i class="fa fa-angle-right"><i>'],
					onInitialize: function(){
						if ( portfolioSlider.find('.portfolio-slider-item').length <= 1 ) {
							this.settings.loop = false;
						}
